...
$(document).ready(function(){
  ...
  function onFinishCallback(objs, context){
    ...
    $(".add-row").click(function(){
      var markup = "<tr><td><input type='checkbox' name='record'></td><td><input  name='dgi_name_commercial[]' class='form-control' type='text' placeholder='Nom commercial'></td><td><input  name='dgi_adress[]' class='form-control' type='text' placeholder='Adresse'></td><td><input  name='dgi_section_com[]' class='form-control' type='text' placeholder='section communale'></td><td><input  name='dgi_zone[]' class='form-control' type='text' placeholder='Zone'></td><td><input  name='dgi_pays[]' class='form-control' type='text' placeholder='Pays'></td></tr>";
